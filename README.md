...
Contribuições são sempre bem-vindas! Se você tem alguma ideia para melhorar o projeto, sinta-se à vontade para abrir uma _issue_ ou enviar um _pull request_.

1.  Faça um _fork_ do projeto.
2.  Crie uma nova _branch_ (`git checkout -b feature/NovaFuncionalidade`).
3.  Faça o _commit_ das suas alterações (`git commit -m 'Adiciona NovaFuncionalidade'`).
4.  Faça o _push_ para a _branch_ (`git push origin feature/NovaFuncionalidade`).
